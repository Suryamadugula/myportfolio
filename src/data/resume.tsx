...
export const DATA = {
  ...
  location: "Ongole, AP",
  locationLink: "https://maps.app.goo.gl/eyATZyMfdaVGBudGA",
  description:
  ...
  contact: {
    email: "madugulasurya9555@gmail.com",
    tel: "+91 9493980677",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Suryamadugula",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/suryaprakashmadugula/",
        icon: Icons.linkedin,
  ...
  work: [
    {
      company: "Vinutna Digital Media",
      badges: [],
      href: "https://vinutnadigitalmedia.com/",
      location: "Remote",
  ...
  education: [
    ...
    },*/
    {
      ...
      href: "https://pace.ac.in/",
      degree: "Bachelor's Degree in Computer Science (BTech)",
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Developed an AI-powered finance assistant using Llama 3.1 LLM model and financial tools, enabling accurate retrieval of financial metrics (e.g., EBITDA, total revenue) and delivering insights with a 95% response accuracy.",
      technologies: [
        "Python",
        "Machine Learning",
        "LangGraph",
    ...
    },
    {
      ...
      active: true,
      description:
        "Implemented an AI-driven web scraping tool using Selenium and BeautifulSoup, successfully scraping and processing data from over 50+ complex websites with vital content.",
      technologies: [
        "Python",
        "Machine Learning",
        "LangGraph",
